...
<html><head>
    ...
    <?php
		...
		$mname=$_GET['nickname'];
		$mlevel=$_GET['difficulty'];
		$mfrom=$_GET['fromStackId'];
		$mto=$_GET['toStackId'];
		$mbrick=$_GET['brickId'];
		...
		if($_SESSION['again']!=NULL || $_SESSION['auto']!=NULL){
			...
			if($_SESSION['again']!=NULL){
				if($_SESSION['again']==$_SESSION['mcount']){
					$_SESSION['stime']=date("H:i:s:u");
					$_SESSION['again']=NULL;
				}else{
					$_SESSION['again']++;
			...
			if($error!=''){
				echo'<script>';
				echo'alert("'.$error.'");';
				echo"location.href='game.php?nickname=".$_SESSION['mname']."&difficulty=".$_SESSION['mlevel']."&fromStackId=".$_SESSION['getfrom'][$_SESSION['mcount']]."&toStackId=".$_SESSION['getto'][$_SESSION['mcount']]."&brickId=".$_SESSION['getbrick'][$_SESSION['mcount']]."'";
				echo'</script>';
			}
			$game->start();
