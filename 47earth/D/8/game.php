...
<head>
    ...
    <?php
		...
		if($_SESSION['auto']!=NULL || $_SESSION['again']!=NULL){
			...
			$game->start();
			if(!($_POST['back']&&$_POST['auto']&&$_POST['again'])){
				$game->go();
			}
			if($_POST['back']){
				echo 'back';
                ...
                <div class="game">
                    ...
                    if($_SESSION['auto']!=NULL){
						...
						for($i=2;$i>=0;$i--){
							...
							for($j=0;$j<=$_SESSION['level']-1;$j++){
								if($box[$i][$j]>0){
									$w=20*$box[$i][$j];
									echo "<div style='width:".$w."px;' class='brick' data-id='".$j."'></div>";
								}
							}
							echo'</div>';
						}
                    ...
                    <div class="clear moveButton">
                        <div class="col3">
                        	<input type="submit" value="2" onClick="btn(2,1)">
                            <input type="submit" value="1" onClick="btn(2,0)">
                        </div>
                        <div class="col3">
                            <input type="submit" value="3" onClick="btn(1,2)">
                            <input type="submit" value="1" onClick="btn(1,0)">
                        </div>
                        <div class="col3">
                        	<input type="submit" value="3" onClick="btn(0,2)">
                            <input type="submit" value="2" onClick="btn(0,1)">
                        </div>
                    </div>
