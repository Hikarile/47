	...
	class game{
		...
		public function start(){
			if($_SESSION['name']==''){
				...
				$_SESSION['bar'][$_SESSION['count']][1]=$this->level;
				$_SESSION['bar'][$_SESSION['count']][2]=0;
				$_SESSION['bar'][$_SESSION['count']][3]=0;
				for($i=1;$i<=$this->level;$i++){
					$a[$i]=$i;
					$b[$i]=0;
				}
				$_SESSION['box'][$_SESSION['count']][1]=$a;
				$_SESSION['box'][$_SESSION['count']][2]=$b;
				$_SESSION['box'][$_SESSION['count']][3]=$b;
