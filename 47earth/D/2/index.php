...
<head>
    ...
    <?php
		...
		if($_GET['nickname']){
			$_SESSION['mname']=$_GET['nickname'];
			$_SESSION['mlevel']=$_GET['difficulty'];
			
			$_SESSION['mfrom']='0';
			$_SESSION['mto']='0';
			$_SESSION['mbrick']='0';
			
			$_SESSION['allcount']=pow(2,$_SDESSION['mlevel'])-1;
			
			$_SESSION['agin']=null;
			$_SESSION['auto']=null;
			
			header("location:game.php?nickname=".$_GET['nickname']."&difficulty=".$_GET['difficulty']);
		}
	?>
