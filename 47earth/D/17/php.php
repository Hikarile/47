		...
		public function go (){
			if(!($_SESSION['name']==$this->name && $_SESSION['level']==$this->level && $_SESSION['from'][$_SESSION['count']]==$this->from && $_SESSION['to'][$_SESSION['count']]==$this->to && $_SESSION['brick'][$_SESSION['count']]==$this->brick)){
				...
				if($bar[$this->to] == '0' || $fff<$ttt){
					...
					echo "location.href='game.php?nickname=".$_SESSION['name']."&difficulty=".$_SESSION['level']."&fromStavkId=".$_SESSION['from'][$_SESSION['count']]."&toStavkId=".$_SESSION['to'][$_SESSION['count']]."&brickId=".$_SESSION['brick'][$_SESSION['count']]."';";
					echo '</script>';
				}
