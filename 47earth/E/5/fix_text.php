	...
	$(function(){
		$(document).on('click','input[type="radio"]',function(){
			...
			if(date == '3'){
				...
				for(i=1;i<=4;i++){
					var da='<label id="lb3'+count+i+'">'+i+'.<input type="text" name="da3'+count+'['+i+']" id="da3'+count+i+'" class="t">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正確答案<input type="checkbox" name="correct3'+count+'['+i+']" id="correct3'+count+i+'" class="correct" value="'+i+'"><br/></label>';
        ...
        <form method="post" action="fix.php" id="sub">
			...
			<table width="80%" height="150px" bgcolor="#FF9900" border="1">
                <tr>
                    ...
                    <td>
                        問題題型:<br/>
                        <input class="correct" type="radio" name="type[<?=$_SESSION['count']?>]" count="<?=$_SESSION['count']?>" date="1"<?php if($qa['type']=='1'){echo' checked';}?>>是非題&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="correct" type="radio" name="type[<?=$_SESSION['count']?>]" count="<?=$_SESSION['count']?>" date="2"<?php if($qa['type']=='2'){echo' checked';}?>>單選題&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="correct" type="radio" name="type[<?=$_SESSION['count']?>]" count="<?=$_SESSION['count']?>" date="3"<?php if($qa['type']=='3'){echo' checked';}?>>多選題&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <p/>
                        ...
                        <div id="div2<?=$_SESSION['count']?>"<?php if($qa['type']!='2'){echo' hidden';}?>>
                            ...
                            $da=explode(',',$qa['da']);
							?>
                            1.<input type="text" name="da2<?=$_SESSION['count']?>[1]" id="da2<?=$_SESSION['count']?>1" class="t" value="<?=$da[0]?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            2.<input type="text" name="da2<?=$_SESSION['count']?>[2]" id="da2<?=$_SESSION['count']?>2" class="t" value="<?=$da[1]?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            3.<input type="text" name="da2<?=$_SESSION['count']?>[3]" id="da2<?=$_SESSION['count']?>3" class="t" value="<?=$da[2]?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            4.<input type="text" name="da2<?=$_SESSION['count']?>[4]" id="da2<?=$_SESSION['count']?>4" class="t" value="<?=$da[3]?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <br/>
                            正確答案:
            ...
            <label class="time">作答時間<input type="number" name="time1" id="time1" max="60" min="10" value="<?=$text['time1']?>" class="t">秒</label><br/>
            <label class="time">統計觀看時間<input type="number" name="time2" id="time2" max="60" min="10" value="<?=$text['time2']?>" class="t">秒</label><br/>
