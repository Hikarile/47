...
<body bgcolor="#FFFF99">
	<center><h1>
        ...
        <form method="post">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($_SESSION['type'][$count]=='1'){
							echo '<label class="annotation">ćŻééĄ</label>';
						}else if($_SESSION['type'][$count]=='2'){
							echo '<label class="annotation">ĺŽé¸éĄ</label>';
						}else if($_SESSION['type'][$count]=='3'){
							echo '<label class="annotation">č¤é¸éĄ</label>';
						}
						?><p/>
                        ...
                        if($_SESSION['type'][$count] == '1'){
							...
							?>
							<input class="da" type="radio" name="da" value="ćŻ">ćŻ
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input class="da" type="radio" name="da" value="ĺŚ">ĺŚ
							<?php
							}else{
							?>
							<input class="da" type="radio" name="da" value="ćŻ" disabled <?php if($_SESSION['ok'][$count]=="ćŻ"){echo'checked';}?>>ćŻ
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input class="da" type="radio" name="da" value="ĺŚ" disabled <?php if($_SESSION['ok'][$count]=="ĺŚ"){echo'checked';}?>>ĺŚ
							<?php
							}
            ...
            <?php
            if($_SESSION['ok'][$count]==''){
				echo'<input type="submit" name="ok" value="ç˘şĺŽ">';
			}
			?>
        </form>
    </h1></center>
