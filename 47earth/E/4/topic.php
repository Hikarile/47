...
<table bgcolor="#FF9933" width="80%" height="150px" border="1">
	<tr>
        ...
        <td>
            ...
            問題題目:<br/>
            <textarea class="q" id="q<?=$_SESSION['count']?>" name="q[<?=$_SESSION['count']?>]"></textarea><p/>
            ...
            <div id="div1<?=$_SESSION['count']?>" hidden>
                ...
                2.否&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                正確答案:
                <select class="correct" name="correct1[<?=$_SESSION['count']?>]" id="correct1<?=$_SESSION['count']?>">
            ...
            <div id="div2<?=$_SESSION['count']?>" hidden>
            	...
            	正確答案:
                <select class="correct" name="correct2[<?=$_SESSION['count']?>]" id="correct2<?=$_SESSION['count']?>">
