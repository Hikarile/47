	...
	if($_POST['ok']){
		...
		if($ac == ''){
			...
			if($login=mysqli_fetch_array($lo)){
				...
				$mysql->query("INSERT INTO `login` (`type`, `ac`, `ps`) VALUES ('$type', '$ac', '$ps')");
				echo '<script>';
				echo 'alert("新增成功");';
...
<body bgcolor="#FFFF99">
	<input type="button" value="返回" onClick="location.href='teacher.php'" class="out">
    <center><h1>
        ...
        <div class="box1">
        	<form method="post">
                ...
                密碼:<input type="text" name="ps" class="text"><p/>
                角色:
