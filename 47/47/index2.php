...
<?php
	...
	if($_POST['ok']){
		...
		$mysql->query("INSERT INTO `eat` (`number`, `day`, `mon`, `tp`, `quan`, `menu`, `tab`, `tnum`, `money`, `moneymoney`)
					VALUES ('$number', '$day', '$mon', '$tp', '$quan', '$menu', '$tab', '$tnum', '$money', '$moneymoney')");
        ...
        <form method="post">
        	<table width="30%">
            	...
            	<tr>
                    ...
                    <td><input type="text" name="mon" value="<?=$da[1]?>"></td>
                </tr>
                <tr>
