...
<body bgcolor="#6699FF">
	<center><h1>
        ...
        <div style="width:80%; height:600px; border-radius:20px; background-color:#FFF;">
        	<?=$day?><p/>
        ...
        <form method="post" action="index2.php">
            ...
            <input type="submit" value="確定" style="width:150px; height:100px; font-size:40px" hidden id="oo"><br/>
