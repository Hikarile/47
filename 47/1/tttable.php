...
<style>
	...
	.small{
		...
		width: 150px;
		height: 100px;
		margin: 20px;//margin-right: 100px;
	}
	.small5{
		display: inline-block;
		border: 1px solid #000;
...
<body bgcolor="#6699FF">
    ...
    <center><h1>
        ...
        <input type="button" value="取消選取" onClick="location.href='ttable.php?day=<?=$day?>&tp=<?=$ttp?>'">
        <input type="button" value="放棄離開" onClick="location.href='ef.php'">
    </h1></center>
