...
<?php
	...
	if($_GET['oo']){
		header("location:index3.php?day=".$_GET['day']."&mon=".$_GET['mon']."&tp=".$_GET['tp']."&quan=".$_GET['quan']."&menu=".$_GET['menu']."&tab=".$_GET['tab']."&tnum=".$_GET['tnum']."&money=".$_GET['money']."&moneymoney=".$_GET['moneymoney']."&oo=".$_GET['oo']."&dd=".$_GET['dd']);
	}
