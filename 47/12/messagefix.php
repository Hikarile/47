...
<?php
	...
	if($_POST['ok']){
		...
		if($a==''){
			...
			$mysql->query("UPDATE `message` SET `name` = '$name', `email` = '$email', `phone` = '$phone', `ey` = '$ey', `py` = '$phone', `text` = '$text', `number` = '$number', `ftime` = '$text' WHERE `message`.`id` ='$id'");
...
<body bgcolor="#6699FF">
	<center><h1>
    	修改留言<input type="button" value="返回" onClick="lcoation.href='message.php'"><p/>
        ...
        <form method="post" enctype="multipart/form-data">
        	<table width="30%">
                ...
                <tr>
                	<th bgcolor="#CCCCCC" width="50%">圖片</th>
