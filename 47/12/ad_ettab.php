...
<body bgcolor="#6699FF">
	<center><h1>
        ...
        <div style="width:80%; height:600px; border:#000 solid 1px; border-radius:20px; background:#FFF;">
        	<?=$day?><p/>
        ...
        <form method="post" action="index2.php">
            ...
            <input type="hidden" name="tp" value="<?=$day?>">
            ...
            <input type="button" value="取消選取" onClick="location.href='ttab.php?day=<?=$day?>&tp=<?=$tp?>&quan=<?=$quan?>&menu=<?=$menu?>&tab=<?=$tab?>&id=<?=$id?>'">
