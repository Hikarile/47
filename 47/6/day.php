<?php
	...
	$mon=date("N")-1;
?>
<table id="big1" width="80%" height="60px" border="1" bgcolor="#FFFFFF">
	<tr>
    ...
    <tr height="100px">
        ...
        for($i=0;$i<=6;$i++){
			...
			if($ten==0){
				...
				echo'<th class="a" onClick="cl(\''.$day.'\',\'午餐\','.$ten.','.$i.',this)">'.$ten.'</th>';
			}
		}
		?>
    </tr>
    <tr height="100px">
        ...
        for($i=0;$i<=6;$i++){
			...
			if($ten==0){
				...
				echo'<th class="a" onClick="cl(\''.$day.'\',\'下午茶\','.$ten.','.$i.',this)">'.$ten.'</th>';
			}
		}
		?>
    </tr>
    <tr>
        ...
        for($i=0;$i<=6;$i++){
			...
			if($ten==0){
				...
				echo'<th class="a" onClick="cl(\''.$day.'\',\'晚餐\','.$ten.','.$i.',this)">'.$ten.'</th>';
			}
		}
		?>
    </tr>
