...
<?php
	...
	if($_POST['ok']){
		...
		$mysql->query("INSERT INTO `eat` (`day`, `mon`, `session`, `tp`, `quan`, `menu`, `tab`, `tnum`, `money`, `moneymoney`, `new`, `c`) VALUES ('$day', '$mon', '$session', '$tp', '$quan', '$menu', '$tab', '$tnum', '$money', '$moneymoney', '$new', '$c')");
