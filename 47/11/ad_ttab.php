...
<body bgcolor="#6699FF">
	<center><h1>
        ...
        <form method="post" action="ad_eff.php">
            ...
            <input type="button" value="取消選取" onClick="location.href='ad_ttab.php?day=<?=$day?>&tp=<?=$tp?>&quan=<?=$quan?>&menu=<?=$menu?>&tab=<?=$tab?>&c=<?=$c?>&id=<?=$id?>'">
            <input type="button" value="放棄離開" onClick="location.href='ad_e.php'">
        </form>
    </h1></center>
</body>
</html>