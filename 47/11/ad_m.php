		...
		<div class="d0">
            ...
            <div class="d4">
				...
				<form method="post">
                	...
                	<input type="button" value="回覆" onClick="location.href='ad_mreply.php?id=<?=$a['id']?>'">
                    <input type="submit" name="up" value="置頂"><br/>
                    <input type="button" value="修改" onClick="location.href='ad_mfix.php?id=<?=$a['id']?>'">
