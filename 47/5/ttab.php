...
<body bgcolor="#6699FF">
    ...
    <center><h1>
        ...
        <div style="width:80%; height:650px; border:#000 solid 1px; border-radius:20px; background-color:#FFF;">
            ...
            <div class="d0" id="t10" onClick="cl('010',this)">
            	10桌<br/><label id="a10"><?php if(in_array('010',$da)){echo'空';}else{echo'已訂';}?></label>
            </div>
        </div><p/>
        <div style="width:80%; height:60px; border:#000 solid 1px; background-color:#FFF;">
        	你還可以選<label id="da"><?=$tab?></label>桌
        </div>
        ...
        <form method="post" action="index2.php">
            ...
            <input style="width:200px; height:130px; font-size:30px;" type="submit" value="確定選取" id="ok" hidden><p/>
